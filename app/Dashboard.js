...
const AGENT_DATA = [
  { name: "Hugo Guerrero", orders: 1091, avgTime: 969.8, medianTime: 7.5, revenue: 1204825, acceptance: 96.5, pl: "Lazr Freight" },
  { name: "Jessica Jacob", orders: 310, avgTime: 266.2, medianTime: 3.0, revenue: 239399, acceptance: 95.2, pl: "Lazr Freight" },
  { name: "RAUL ALMANZA", orders: 303, avgTime: 3085.0, medianTime: 1557.6, revenue: 631721, acceptance: 96.7, pl: "Synergie Canada" },
  { name: "Rubi Rodriguez", orders: 235, avgTime: 1282.3, medianTime: 31.4, revenue: 380409, acceptance: 90.2, pl: "Lazr Freight" },
  { name: "Bessy Lappas", orders: 197, avgTime: 336.3, medianTime: 104.9, revenue: 142992, acceptance: 69.5, pl: "Synergie Canada" },
  { name: "Susana Delgado", orders: 175, avgTime: 223.7, medianTime: 8.4, revenue: 152047, acceptance: 96.0, pl: "Lazr Freight" },
  { name: "Eve-Lyne Cuggia", orders: 129, avgTime: 536.2, medianTime: 176.0, revenue: 99946, acceptance: 62.0, pl: "Synergie Canada" },
  { name: "Arminder Singh", orders: 113, avgTime: 681.8, medianTime: 98.0, revenue: 264592, acceptance: 86.7, pl: "Synergie Canada" },
  { name: "Yamen Touma", orders: 101, avgTime: 655.4, medianTime: 136.0, revenue: 297554, acceptance: 63.4, pl: "Synergie Canada" },
  { name: "Jean-do Schmitt", orders: 92, avgTime: 749.8, medianTime: 229.3, revenue: 169850, acceptance: 56.5, pl: "Synergie Canada" },
  { name: "Leslie Sansano", orders: 86, avgTime: 101.1, medianTime: 3.3, revenue: 18729, acceptance: 100.0, pl: "Lazr Freight" },
  { name: "Joel Picard", orders: 86, avgTime: 442.4, medianTime: 80.2, revenue: 134398, acceptance: 62.8, pl: "Synergie Canada" },
  { name: "Alexandra Rodriguez", orders: 76, avgTime: 370.3, medianTime: 98.3, revenue: 60767, acceptance: 73.7, pl: "Synergie Canada" },
  { name: "Marie-christine P.", orders: 65, avgTime: 2692.3, medianTime: 1083.3, revenue: 95525, acceptance: 70.8, pl: "Synergie Canada" },
  { name: "Catherine V-F.", orders: 44, avgTime: 171.9, medianTime: 106.2, revenue: 38674, acceptance: 88.6, pl: "Synergie Canada" },
];
      ...
      <div style={{ maxWidth: 1200, margin: "0 auto", padding: "0 32px" }}>
        ...
        {activeTab === "Agent Performance" && (
          <>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: 16 }}>
              <KPICard icon="👥" label="Total Agents" value="15" sub="Active 3PL agents" color={COLORS.accent} />
              <KPICard icon="⚡" label="Best Median Time" value="3.0 min" sub="Jessica Jacob" color={COLORS.green} />
              <KPICard icon="🐢" label="Slowest Median" value="1,558 min" sub="RAUL ALMANZA" color={COLORS.rose} />
              <KPICard icon="🏆" label="Top Acceptance" value="100%" sub="Leslie Sansano (86 quotes)" color={COLORS.green} />
            </div>
