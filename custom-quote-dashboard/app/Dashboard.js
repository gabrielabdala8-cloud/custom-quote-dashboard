...
const RAW_DATA = [
  // 3PL Breakdown
  { threepl: "Lazr Freight", orders: 1695, revenue: 1555404, profit: 206472, cost: 1348932 },
  { threepl: "Synergie Canada", orders: 1128, revenue: 1843875, profit: 91395, cost: 1752480 },
];
...
const MONTHLY = [
  ...
  { month: "Apr 26", orders: 53, revenue: 34387, profit: 1919 },
];

const ORDER_STATUS = [
  { name: "Completed", value: 2351, revenue: 2817144 },
  { name: "Billing", value: 419, revenue: 490449 },
  { name: "Reservation", value: 32, revenue: 55527 },
  { name: "Transport", value: 19, revenue: 28236 },
  { name: "Negotiation", value: 2, revenue: 7922 },
];

const TOP_CLIENTS = [
  { name: "Ryder Cascades", orders: 1324, revenue: 1656019 },
...
const LANE_TYPE = [
  { name: "Intra-CA", orders: 1173, revenue: 1557094 },
  { name: "Intra-QC", orders: 829, revenue: 590401 },
  { name: "Intra-US", orders: 355, revenue: 578842 },
  { name: "CA-to-US", orders: 306, revenue: 442603 },
  { name: "US-to-CA", orders: 141, revenue: 187548 },
];

const SALES_REPS = [
  { name: "Marc-André G.", orders: 2274, revenue: 2834023 },
  { name: "Krystelle D.", orders: 184, revenue: 228361 },
  { name: "Patrick D.", orders: 202, revenue: 146276 },
  { name: "Devon T.", orders: 48, revenue: 80788 },
  { name: "Yann M.", orders: 67, revenue: 70384 },
  { name: "Catherine G.", orders: 45, revenue: 38605 },
];

const TRANSPORT_TYPE = [
  { name: "LTL", orders: 2548, revenue: 2657663 },
...
const tabs = ["Overview", "3PL Analysis", "Clients & Lanes"];

export default function Dashboard() {
  const [activeTab, setActiveTab] = useState("Overview");

  const totalRevenue = 3399279;
  const totalCost = 3101413;
  const totalProfit = 297867;
  const totalOrders = 2823;
